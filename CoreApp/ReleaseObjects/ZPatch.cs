...
namespace CoreApp.FixpackObjects
{
    public class ZPatch
    {
        ...
        public HashSet<ZPatch> dependendFrom { get; private set; }
        public HashSet<ZPatch> dependOn { get; private set; }
        ...
        {
            dependendFrom = new HashSet<ZPatch>();
            dependOn = new HashSet<ZPatch>();
        ...
        public override bool Equals(object obj)
        {
            ...
            return ((ZPatch)obj).name.Equals(name, StringComparison.CurrentCultureIgnoreCase);
        }
    }
}
